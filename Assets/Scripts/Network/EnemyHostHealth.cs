...
using UnityEngine;
using multi;
public class EnemyHostHealth : MonoBehaviour
{
    ...
    void Death()
    {
		...
		clientServer.multiplayerHandler.SendEnemyHPData (myName, gameObject.GetComponent<EnemyHostMovement> ().ID, (double)0);
    }
